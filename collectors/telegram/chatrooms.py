...
class TelegramChatroomsMixin(TelegramCollectorDeps):
    def _is_invalid_chatroom_target(self, chat_type, chat_name):
        ...
        # Telegram UI action rows can be misclassified as chatrooms.
        # They must not become collection targets, otherwise Online/Offline
        # completion can wait forever for an impossible logical_chatroom_id.
    ...
    def _is_ambiguous_deleted_account(self, chatroom_name, chatroom_user_id, chatroom_mobile, chatroom_type=None):
        ...
        # If type is available, require Direct; if unavailable, do not block.
    ...
    def _make_storage_chatroom_id(self, logical_chatroom_id, ambiguous_deleted):
        ...
        # This suffix is not a stable UI/chat identity.
        # It only separates indistinguishable Deleted Account acquisition encounters.
        # This is a conservative forensic collection policy to avoid merges/omissions.
    ...
    def check_chatroom_type(self):
        ...
        if 'subscriber' in chatroom_type:
            chatroom_type = 'Channel'
        elif 'member' in chatroom_type:
            chatroom_type = 'Group'
