...
class TelegramAttachmentsMixin(TelegramCollectorDeps):
    ...
    def _log_attachment_download_success(
        ...
        *,
        ...
        ended_audit_seq = self.log_action('attachment_download_end', selector=str(msg_type), artifacts=artifacts)
        logger.info(
        ...
        return ended_audit_seq

    def _build_attachment_attempt_payload(
        self,
        *,
        attempt_id,
        phase,
        ...
        screenshot_evidence = screenshot_evidence or {}
        uitree_evidence = uitree_evidence or {}
        screenshot_artifact = screenshot_evidence.get("screenshot_artifact") or {}
        uitree_artifact = uitree_evidence.get("uitree_artifact") or {}
        artifact_paths = [item.get("artifact_path") for item in copied_artifacts if item.get("artifact_path")]
        artifact_ids = [item.get("artifact_id") for item in copied_artifacts if item.get("artifact_id")]
        ...
        return {
            ...
            "method": "S1",
            "primitive": "before_after_snapshot_diff",
            "route_id": "telegram_attachment_download",
            "target_type": "attachment",
            "target_label": display_filename,
            ...
            "error": error,
            "ui_reached": 1,
            "artifact_materialized": 1 if artifact_paths else 0,
            "started_audit_seq": started_audit_seq,
            "ended_audit_seq": ended_audit_seq,
            "started_ts": start_ts,
            "ended_ts": ended_ts,
            ...
            "screenshot_artifact_id": screenshot_artifact.get("artifact_id"),
            "uitree_artifact_id": uitree_artifact.get("artifact_id"),
            "screenshot_path": screenshot_evidence.get("screenshot_path"),
            "uitree_path": uitree_evidence.get("uitree_path"),
    ...
    def _download_attachment(self, msg, msg_type, bounds, download_dir, message_id=None, observation_id=None, record_id=None, page_index=None, page_row_index=None, identity_status=None, dedup_policy=None, download_gate_key=None, policy_source=None, policy_version=None):
        ...
        started_audit_seq = self.log_action(
        ...
        def _record_attachment_attempt(
            ...
            *,
            ...
            screenshot_evidence: dict | None = None,
            uitree_evidence: dict | None = None,
            ended_audit_seq: int | None = None,
        ):
            copied_artifacts = copied_artifacts or []
            ended_ts = time.time()
            try:
                payload = self._build_attachment_attempt_payload(
                    ...
                    uitree_evidence=uitree_evidence,
                    identity_status=identity_status,
                    dedup_policy=dedup_policy,
                    download_gate_key=download_gate_key,
                    policy_source=policy_source,
                ...
                self.storage.upsert_attachment_attempt(payload)
            except Exception as e:
                self.log_action(
        ...
        def _fail(reason: str, *, error: Exception | None = None, extra: list[str] | None = None):
            ...
            try:
                ...
                screenshot_evidence = {
                    ...
                    "screenshot_artifact": ev.get("screenshot_artifact"),
                }
                uitree_evidence = {
                    "uitree_path": uitree_path,
                    "uitree_artifact": ev.get("uitree_artifact"),
                }
            ...
            ended_audit_seq = self.log_action(
        ...
        try:
            if msg_type in ('Photo', 'Video'):
                ...
                ended_audit_seq = self._log_attachment_download_success(
                    msg_type=msg_type,
                    copied_artifacts=copied_artifacts,
                ...
                _record_attachment_attempt("success", copied_artifacts=copied_artifacts, ended_audit_seq=ended_audit_seq)
