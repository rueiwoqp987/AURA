...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Example:\n"
            "  python main.py --target telegram --serial <ADB_SERIAL> --keep-run-dir"
        ),
    )
    parser.add_argument("--target", default="telegram", choices=sorted(PROFILE_REGISTRY), help="Target app")
    parser.add_argument("--serial", default=None, help="ADB device serial. Omit when exactly one device is connected.")
    parser.add_argument("--runs-dir", default="runs", help="Run output root")
